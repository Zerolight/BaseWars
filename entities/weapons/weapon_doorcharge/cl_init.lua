...
if (file.Exists( "materials/weapons/weapon_mad_charge.vmt", "GAME" )) then
...
function SWEP:Think()
	...
	if trace.Hit and trace.Entity:GetClass() == "prop_door_rotating" and not self:GetNWBool("Planted") then
