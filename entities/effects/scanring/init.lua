function EFFECT:Init( data )
	...
	self:SetRenderBoundsWS( self.RingCenter+Vector(self.MaxRingRadius,self.MaxRingRadius,20), self.RingCenter-Vector(self.MaxRingRadius,self.MaxRingRadius,-20) )
end
