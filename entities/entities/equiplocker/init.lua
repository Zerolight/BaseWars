...
function ENT:Touch(gun)
	if ((gun:GetClass()=="item_adrenaline" or gun:GetClass()=="item_armorpiercer" or gun:GetClass()=="item_leech" or gun:GetClass()=="item_doublejump" or gun:GetClass()=="item_shockwave" or gun:GetClass()=="item_doubletap" or gun:GetClass()=="item_magicbullet" or gun:GetClass()=="item_knockback" or gun:GetClass()=="item_uberdrug" or gun:GetClass()=="item_superdrugweapmod" or gun:GetClass()=="item_superdrugdefense" or gun:GetClass()=="item_superdrugoffense" or gun:GetClass()=="item_superdrug" or gun:GetClass()=="item_snipeshield" or gun:GetClass()=="item_regen" or gun:GetClass()=="item_steroid" or gun:GetClass()=="item_painkiller" or gun:GetClass()=="item_amp" or gun:GetClass()=="item_armor" or gun:GetClass()=="item_buyhealth" or gun:GetClass()=="item_antidote" or gun:GetClass()=="item_helmet" or gun:GetClass()=="item_reflect" or gun:GetClass()=="item_focus" or gun:GetClass()=="item_random" or gun:GetClass()=="item_drug" or gun:GetClass()=="item_booze" or gun:GetClass()=="item_food" or gun:GetClass()=="item_scanner" or gun:GetClass()=="item_toolkit") and table.Count(self.Guns)<20 and gun:GetTime()<CurTime()-5) then
