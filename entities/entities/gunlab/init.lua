...
function ENT:Use( activator )
	...
	timer.Create( tostring(self) .. "spawned_weapon", 0.5, 1, function() if IsValid( self ) then self:createGun() end end )
	...
	self.Ready = false
	if (canupgrade and activator:CanAfford(upgradecost)) then
