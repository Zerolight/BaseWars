...
function ENT:Initialize()
	...
	self.SnipeShield:SetPos(self:GetPos()+self:GetAngles():Forward()*-10+self:GetAngles():Right()*-25+self:GetAngles():Up()*15)
	self.SnipeShield:SetAngles(Angle(0,0,0))
	self.SnipeShield:SetParent(self)
	...
	self.SnipeShield2:SetPos(self:GetPos()+self:GetAngles():Forward()*10+self:GetAngles():Right()*-25+self:GetAngles():Up()*15)
	self.SnipeShield2:SetAngles(Angle(0,0,0))
	self.SnipeShield2:SetParent(self)
	...
	self.SnipeShield3:SetPos(self:GetPos()+self:GetAngles():Forward()*-10+self:GetAngles():Right()*-5+self:GetAngles():Up()*15)
	self.SnipeShield3:SetAngles(Angle(0,0,0))
	self.SnipeShield3:SetParent(self)
	...
	self.SnipeShield4:SetPos(self:GetPos()+self:GetAngles():Forward()*10+self:GetAngles():Right()*-5+self:GetAngles():Up()*15)
	self.SnipeShield4:SetAngles(Angle(0,0,0))
	self.SnipeShield4:SetParent(self)
	...
	self.Armor:SetPos(self:GetPos()+self:GetAngles():Forward()*10+self:GetAngles():Right()*-30+self:GetAngles():Up()*49)
	self.Armor:SetAngles(Angle(0,0,0))
	self.Armor:SetParent(self)
	...
	self.Armor2:SetPos(self:GetPos()+self:GetAngles():Forward()*-10+self:GetAngles():Right()*-30+self:GetAngles():Up()*49)
	self.Armor2:SetAngles(Angle(0,0,0))
	self.Armor2:SetParent(self)
	...
	self.Armor3:SetPos(self:GetPos()+self:GetAngles():Forward()*10+self:GetAngles():Right()*-10+self:GetAngles():Up()*49)
	self.Armor3:SetAngles(Angle(0,0,0))
	self.Armor3:SetParent(self)
	...
	self.Armor4:SetPos(self:GetPos()+self:GetAngles():Forward()*-10+self:GetAngles():Right()*-10+self:GetAngles():Up()*49)
	self.Armor4:SetAngles(Angle(0,0,0))
	self.Armor4:SetParent(self)
	...
	self.Helmet:SetPos(self:GetPos()+self:GetAngles():Forward()*-10+self:GetAngles():Right()*30+self:GetAngles():Up()*10)
	self.Helmet:SetAngles(Angle(0,270,0))
	self.Helmet:SetParent(self)
	...
	self.Helmet2:SetPos(self:GetPos()+self:GetAngles():Forward()*10+self:GetAngles():Right()*30+self:GetAngles():Up()*10)
	self.Helmet2:SetAngles(Angle(0,270,0))
	self.Helmet2:SetParent(self)
	...
	self.Helmet3:SetPos(self:GetPos()+self:GetAngles():Forward()*-10+self:GetAngles():Right()*20+self:GetAngles():Up()*10)
	self.Helmet3:SetAngles(Angle(0,270,0))
	self.Helmet3:SetParent(self)
	...
	self.Helmet4:SetPos(self:GetPos()+self:GetAngles():Forward()*10+self:GetAngles():Right()*20+self:GetAngles():Up()*10)
	self.Helmet4:SetAngles(Angle(0,270,0))
	self.Helmet4:SetParent(self)
	...
	self.toolkit:SetPos(self:GetPos()+self:GetAngles():Forward()*10+self:GetAngles():Right()*30+self:GetAngles():Up()*35)
	...
	self.toolkit2:SetPos(self:GetPos()+self:GetAngles():Forward()*-10+self:GetAngles():Right()*30+self:GetAngles():Up()*35)
	...
	self.toolkit3:SetPos(self:GetPos()+self:GetAngles():Forward()*10+self:GetAngles():Right()*10+self:GetAngles():Up()*40.5)
	self.toolkit3:SetAngles(Angle(0,0,0))
	self.toolkit3:SetParent(self)
	...
	self.toolkit4:SetPos(self:GetPos()+self:GetAngles():Forward()*-10+self:GetAngles():Right()*10+self:GetAngles():Up()*40.5)
	self.toolkit4:SetAngles(Angle(0,0,0))
	self.toolkit4:SetParent(self)
...
function ENT:Use(activator,caller)
	upgradenum = self:GetNWEntity("upgrade")
...
function ENT:Think()
	...
	if ((self.Owner or self:GetOwner())==false) then
		self:Remove()
	end
