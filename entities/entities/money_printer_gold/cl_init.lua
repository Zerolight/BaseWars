...
function ENT:Draw( )
	...
	cam.Start3D2D(Pos + Ang:Up() * 4, Ang, 0.12)
		draw.WordBox(.75, -TextWidth*0.5, -70, "Gold Money Printer", "HUDNumber5", Color(255, 215, 0, 155), Color(255,255,255,255))
		draw.WordBox(.75, -TextWidth2*0.5, -24, "Level:"..upgrade, "HUDNumber5", Color(255, 215, 0, 155), Color(255,255,255,255))
