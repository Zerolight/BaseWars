...
function ENT:Draw( )
	...
	local TextWidth = surface.GetTextSize("Stable Meth Lab")
	...
	cam.Start3D2D(Pos + Ang:Right() * -150, TextAng, 0.2)
		draw.WordBox(.7, -TextWidth*0.5, -30, "Stable Meth Lab", "HUDNumber5", Color(0, 0, 0, 155), Color(255,255,255,255))
