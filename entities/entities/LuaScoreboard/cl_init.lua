...
surface.CreateFont( "HostFont", { font = "Trebuchet22", size = 50, weight = 700, antialias = true, shadow = false } )
surface.CreateFont( "PlayerFont", { font = "Trebuchet22", size = 40, weight = 700, antialias = true, shadow = false } )
...
function ENT:Draw()
	...
	cam.Start3D2D(self:GetPos() - self:GetAngles():Forward() * 190 + self:GetAngles():Right() * 190, self:GetAngles() + Angle(90, 90, 90), 0.3)
		...
		draw.RoundedBox(3, 0, 0, 1270, 50, Color(51, 102, 255, 255)  )
		draw.RoundedBox(3, 0, 70, 1270, 50, Color(51, 102, 255, 255)  )
		...
		for k,v in pairs(player.GetAll()) do
			...
			draw.RoundedBox(3, 0, Slots[k], 875, 50, Color(51, 102, 255, 255)  )
			draw.RoundedBox(3, 885, Slots[k], 195, 50, Color(51, 102, 255, 255)  )
			draw.RoundedBox(3, 1090, Slots[k], 180, 50, Color(51, 102, 255, 255)  )
