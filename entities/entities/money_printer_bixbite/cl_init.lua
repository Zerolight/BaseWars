...
function ENT:Draw( flags )
	...
	local TextWidth = surface.GetTextSize("Bixbite Money Printer")
	...
	cam.Start3D2D(Pos + Ang:Up() * 18, Ang, 0.2)
		draw.WordBox(.75, -TextWidth*0.5, -70, "Bixbite Money Printer", "HUDNumber5", Color(229, 228, 226, 155), Color(255,255,255,255))
